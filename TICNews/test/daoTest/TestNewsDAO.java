...
public class TestNewsDAO {
	...
	public void test3Add(){
		...
		news01.setOwner(1);
		news01.setTitle("Varios pasajeros de un tranv�a de Manchester defienden a una pareja espa�ola de un xen�fobo");
		news01.setText("Un hombre los increp� por hablar en espa�ol y los invit� a volver a su pa�s. Varios pasajeros se levantaron de sus asientos y le recriminaron su actitud xen�foba. El incidente fue grabado por un joven peruano.");
